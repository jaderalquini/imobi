...
class SystemSQLPanel extends TPage
{
    ...
    public function __construct()
    {
        ...
        foreach ($list as $entry)
        {
            ...
            {
                $options[ substr($entry,0,-4) ] = substr($entry,0,-4);
            }
        }
        ...
        $select->addValidation(_t('SELECT'), new TRequiredValidator);
        
        $this->form->addQuickField( _t('Database'), $database, '50%' );
        $this->form->addQuickField( 'SELECT', $select, '80%' );
