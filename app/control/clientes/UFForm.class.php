...
class UFForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        // creates the form
        $this->form = new TQuickForm('form_UF');
        ...
        $id->addValidation('Sigla', new TRequiredValidator);
        ...
        $this->form->addQuickAction(_t('Back to the listing'),new TAction(array('UFList','onReload')),'fa:table blue');
        
        // vertical box container
        $container = new TVBox;
        $container->style = 'width: 100%';
        $container->add(new TXMLBreadCrumb('menu.xml', 'UFList'));
