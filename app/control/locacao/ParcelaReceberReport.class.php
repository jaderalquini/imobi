 ...
 */
class ParcelaReceberReport extends TPage
{
    protected $form; // form
    ...
    function onGenerate()
    {
        ...
        {            
            ...
            {   
                ...
                $designer->setTitle('Relação de Parcelas à Receber');
            	...
            	if (!file_exists("app/output/ParcelaReceberReport.{$format}") OR is_writable("app/output/ParcelaReceberReport.{$format}"))
                {
                    $designer->save("app/output/ParcelaReceberReport.{$format}");
                }
                else
                {
                    throw new Exception(_t('Permission denied') . ': ' . "app/output/ParcelaReceberReport.{$format}");
                }
                
                // open the report file
                parent::openFile("app/output/ParcelaReceberReport.{$format}");
            }
            else
            {
