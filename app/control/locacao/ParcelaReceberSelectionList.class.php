 ...
 */
class ParcelaReceberSelectionList extends TWindow
{
    private $form; // form
    ...
    public function onSelect($param)
    {
        try
        {
            ...
            $parcela = new ParcelaReceber($key);
            
            // closes the transaction
            TTransaction::close();
            
            $object = new StdClass;
            $object->numero = $parcela->numero;
            $object->parcela_de = $parcela->numero;
            
            TForm::sendData('form_ParcelaReceber', $object);
            TForm::sendData('form_ParcelaReceberCollection', $object);
            TForm::sendData('form_ReajusteParcela', $object);
